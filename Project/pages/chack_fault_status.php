...
<?php include "../resources/header_user.php";
 $res = mysql_query("SELECT * FROM `fault_master` WHERE `status_code` !='RP' and user_id='".$_SESSION['id']."' order by `update_date` DESC") or die(mysql_error());
?>
<!--======================================================= -->
<div id="page-wrapper">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
          <h1 class="page-header">Fault Status List</h1>
      </div>
      <!-- /.col-lg-12 -->
