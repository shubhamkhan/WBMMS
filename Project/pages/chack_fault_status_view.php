...
if(isset($_GET['id'])){
 $res = mysql_query("SELECT * FROM `fault_master` M, `fault_details` D WHERE  M.user_id='".$_SESSION['id']."' AND M.`fault_id`= D.`fault_id` AND M.`fault_id`='".$_GET['id']."'") or die(mysql_error());
