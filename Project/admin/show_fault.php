...
<?php include "../resources/header.php";
 $res = mysql_query("SELECT * FROM `".$database."`.`fault_master` WHERE `status_code`!='RP' order by `update_date` DESC") or die(mysql_error());
?>
<!--======================================================= -->
<div id="page-wrapper">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
          <h1 class="page-header">Fault Status</h1>
      </div>
      <!-- /.col-lg-12 -->
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <?php while($row = mysql_fetch_array($res)){ ?>
                                    <tr>
                                        ...
                                        <td align="center"><a style="text-decoration:none" href="chack_fault_status_view.php?id=<?php echo $row['fault_id'];?>">
